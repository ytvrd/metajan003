...
<div class="left1">
    ...
    <div class="left12">
        <p><font size="4">MetaJan番販用</font></p>
    </div>
    <div class="left13">
        <button id="sinkiban" type="button" style="width:100%;font-size:20px;" >新規作成</button>
    </div>
    <div class="left14">
        <button id="manual" type="button" style="width:100%;font-size:20px;">番販用コピー</button>
    </div>
</div>
<div class="left2">
    <div class="left21">
...
<div class="right1">
    <div class="right101">
            ...
            <input type="button" value="メタデータ読み込み" name="read" id="read_ban">
    </div>
    <div class="right102">
...
<div class="right3">
    ...
    <div class="right305">
        <input id="mediano" type="text" name="mediano" size="20" value="{{$items["fileid"]}}">
    </div>
</div>
<div class="right4">
    <div class="right401">
    ...
    <div class="right408">
        <input id="housoujikoku" type="text" name="housoujikoku" value="10:00:00">
    </div>
</div>
<div class="right5">
    <div class="right501">
...
<div class="right8">
    ...
    <div class="right806">
        {{Form::select('roudnessf', ['', 'テープ毎','総尺'],2,['id'=>'roudness'])}}
    </div>
</div>
<div class="right9">
    <div class="right901">
...
<div class="right15">
    ...
    <div class="right1502">
        <input id="sagyounum" type="text" name="sagyounum" value="{{$items["sagyounum"]}}">
    </div>
    <div class="right1503">
        件
    </div>
...
<div class="right17">
    ...
    <div class="right1702">
        <input id="seisakunum" type="text" name="seisakunum" value="{{$items["seisakunum"]}}">
    </div>
    <div class="right1703">
        件
    </div>
...
<div class="left1">
    ...
    <div class="left14">
        <button id="js-copybtn" type="button" style="width:100%;font-size:20px;">番販用コピー</button>
    </div>
</div>
<div class="left2">
    <div class="left21">
